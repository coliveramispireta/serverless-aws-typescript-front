...
export default function InfoDialog(props: InfoDialogProps) {
  ...
  return (
    <MessageDialog
      title={props.title ?? "Info"} //El operador ?? te dice que si props.title no es nulo o indefinido, pone el titulo, de lo contrario, pone el coso despues de ??, en este caso, exito
      message={props.message}
      open={props.open}
      icon={<InfoIcon fontSize="large" color="info" />} //hay tres variantes: success, warning, error e info
