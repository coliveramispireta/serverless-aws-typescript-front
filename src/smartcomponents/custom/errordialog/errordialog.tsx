...
export default function ErrorDialog(props: ErrorDialogProps) {
  return (
    <MessageDialog
      title={props.title ?? "Error"} //El operador ?? te dice que si props.title no es nulo o indefinido, pone el titulo, de lo contrario, pone el coso despues de ??, en este caso, exito
      message={props.message}
      open={props.open}
      icon={<ErrorIcon fontSize="large" color="error" />} //hay tres variantes: success, warning, error e info
